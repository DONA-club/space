...
export const SensorPanel = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-red-500/10">
      <LiquidGlassCard className="flex-1 min-h-0 flex flex-col">
        {/* Header - Fixed */}
        <div className="flex items-center justify-between p-4 pb-3 flex-shrink-0 border-b border-gray-200 dark:border-gray-700 bg-blue-500/10">
        ...
        {sensors.length === 0 ? (
          ...
          /* Scrollable Content */
          <div className="flex-1 min-h-0 overflow-y-auto bg-green-500/10">
