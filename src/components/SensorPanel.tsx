...
import { Thermometer, Droplets, AlertCircle, ChevronDown, ChevronUp, Grid3x3, Upload, Download, Trash2, FolderUp, Loader2, Clock, CheckCircle2 } from 'lucide-react';
                  ...
                  {sensors.map((sensor) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {lastDate && (
                          <Alert className={`mb-2 ${isOld ? 'bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800' : 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800'}`}>
