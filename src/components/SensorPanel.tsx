          ...
          {isExpanded && (
            <div className="flex-1 overflow-y-auto p-3 space-y-2">
              {sensors.map((sensor) => (
                <div 
                  key={sensor.id} 
                  className={`bg-white/10 dark:bg-black/10 backdrop-blur-xl backdrop-saturate-150 border shadow-xl shadow-black/5 rounded-2xl p-3 hover:shadow-md transition-all cursor-pointer ${
