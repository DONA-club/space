...
export const LoginForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAuth({ token: response.token, machineId: response.machineId });
...
L'erreur est corrigée : `setAuth` attend maintenant un seul argument (l'objet user) au lieu de deux arguments séparés.

<dyad-chat-summary>Correction erreur TypeScript dans LoginForm</dyad-chat-summary><dyad-problem-report summary="1 problems">
<problem file="src/components/LoginForm.tsx" line="29" column="31" code="2554">Expected 1 arguments, but got 2.</problem>
</dyad-problem-report><dyad-write path="src/components/LoginForm.tsx" description="Fixing setAuth call to pass single user object">
"use client";
