...
export const AuthPage = () => {
  ...
  const [signingIn, setSigningIn] = useState<'google' | 'azure' | null>(null);
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            >
              {signingIn === 'google' ? (
                ...
                <FaGoogle 
                  className="h-16 w-16 text-gray-400 group-hover:text-[#4285F4] transition-colors duration-300 filter grayscale group-hover:grayscale-0"
                />
              )}
            </motion.button>
            ...
            >
              {signingIn === 'azure' ? (
                ...
                <FaMicrosoft 
                  className="h-16 w-16 text-gray-400 group-hover:text-[#00A4EF] transition-colors duration-300 filter grayscale group-hover:grayscale-0"
                />
              )}
            </motion.button>
          </div>
